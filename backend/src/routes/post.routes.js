...
const {createPostController,getAllPostsController, getPostController,getPostDetailController, likePostController, commentPostController, deletePostController, getAllLikesController} = require("../controllers/post.controller")
